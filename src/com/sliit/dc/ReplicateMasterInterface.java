...
public interface ReplicateMasterInterface extends ReplicateInterface {
    ...
    public void takeCharge(String fileName, List<ReplicateLocation> slaveReplicas) throws RemoteException, NotBoundException ;
